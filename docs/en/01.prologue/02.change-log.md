...
### [1.3.19] - 2020-03-03
#### Added
- Added `$payload` support to `StructuredDatumCollection@render`.

#### Fixed
- Fixed issue where `$payload` was not accessible to structured_datum content view.


### [1.3.18] - 2020-01-21
#### Added
- Added garbage collection for structured_datum entries.
