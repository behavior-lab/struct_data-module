<?php namespace ConductLab\StructDataFieldType\Http\Controller;
...
class StructuredDataController extends PublicController
{
    ...
    public function choose(FieldRepositoryInterface $fields, ExtensionCollection $extensions, $field)
    {
        ...
        $extensions = $extensions->search('conduct_lab.module.struct_data::type.*')
            ->enabled()
            ->sort(function ($a, $b) {
                /* @var Addon $a */
                /* @var Addon $b */
...
//dd($extensions);
        return $this->view->make(
            'conduct_lab.field_type.struct_data::choose',
            [
