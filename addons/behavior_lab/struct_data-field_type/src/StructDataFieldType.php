...
use BehaviorLab\StructDataFieldType\Command\GetMultiformFromValue;
use BehaviorLab\StructDataFieldType\Validation\ValidateStructuredData;
...
class StructDataFieldType extends FieldType
{
     ...
     * @var string
     */
    protected $inputView = 'behavior_lab.field_type.struct_data::input';
     ...
     * @var string
     */
    protected $filterView = 'behavior_lab.field_type.struct_data::filter';
    ...
    public function form(FieldInterface $field, StructuredDatumExtension $extension, $instance = null)
    {
        ...
        $form
            ...
            ->setOption('form_view', 'behavior_lab.field_type.struct_data::form')
            ->setOption('wrapper_view', 'behavior_lab.field_type.struct_data::wrapper');
